...
# ---------------------------------------------------------------------------
cells = [
md(banner("Speech & Audio Analytics · Session 3 of 4",
...
md(note("**Next — Session 4, the day's finale.** Here the sound *was* the signal and we threw the words away. Next we do the "
        "opposite: a machine that turns the **spoken word into text** — and how often it mishears. We will transcribe a spoken "
        "report, then measure honestly *how wrong* the transcript can be, and why the one word that matters is the one to watch.")),
]

build(cells, os.path.join(HERE, "..", "notebooks", "03_sound_fault_prediction.ipynb"),
