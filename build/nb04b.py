...
md(section("Pull out the PART NUMBERS hiding in the text", 5)),
...
# --------------------------------------------------------------- E: LDA (bonus)
md(section("Bonus &mdash; discover themes with NO labels (topic modelling)", 6)),
...
# --------------------------------------------------------------- F: 20NG (bonus)
md(section("Bonus &mdash; is this just a toy? Real public data + the honest-test trap", 7)),
...
build(cells, os.path.join(HERE, "..", "notebooks", "04b_text_predict_extract.ipynb"),
      title="Text Analytics II - Predict, Extract, Recurring Faults")
