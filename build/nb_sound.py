...
# ---------------------------------------------------------------------------
cells = [
md(banner("Speech & Audio Analytics · Part 4 of the day",
...
build(cells, os.path.join(HERE, "..", "notebooks", "sound_fault_prediction.ipynb"),
      title="Audio Analytics - Predict a Fault from Sound")
